...
- [ ] **FR-022** — Pinned architecture-specific JDK metadata and aliases.
- [ ] **FR-023** — Pinned Gradle and shared safe extraction.
- [ ] **FR-024** — Complete decoder provenance manifests.
- [ ] **FR-025** — Actionable platform/architecture mismatch reporting.
- [ ] **FR-026** — Equivalent archive, digest, boundary, and rollback safety.
- [ ] **FR-059** — Licensed local schema generation only.
- [ ] **FR-060** — Content-bound SDK licence acceptance.
- [ ] **FR-061** — Decoder-local licence/notice verification.
